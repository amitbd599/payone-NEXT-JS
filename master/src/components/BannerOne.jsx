                    ...
                    <div className='d-flex align-items-center tw-gap-10 flex-wrap'>
                      ...
                      <div className='position-relative'>
                        <span
                          ...
                          className='play-button bg-light-animation tw-w-13 tw-h-13 d-inline-flex justify-content-center align-items-center bg-white text-base-two-600 hover-text-base-two-600 rounded-circle tw-text-xl position-absolute tw-start-50 tw--translate-middle top-50 z-1'
                        >
